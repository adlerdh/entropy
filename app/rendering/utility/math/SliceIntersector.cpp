...
std::pair<std::optional<intersection::IntersectionVertices>, glm::vec4> SliceIntersector::computePlaneIntersections(
...
void SliceIntersector::updatePlaneEquation(const glm::mat4& model_T_camera, const glm::mat4& model_T_frame)
{
