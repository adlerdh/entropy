...
public:
  ...
  /**
   * @brief Export the last rendered ASCII text for one view.
   *
   * The export uses the current ASCII atlas/charset and the cell-mean texture
   * generated by the most recent ASCII render pass. It returns std::nullopt
   * when ASCII mode has not rendered usable cell data yet.
   */
  std::optional<std::string> exportPlainTextForView(const View& view);
