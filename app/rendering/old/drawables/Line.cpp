...
Line::Line(
  ...
  m_positionInfo(BufferComponentType::Float, BufferNormalizeValues::False, 3, sizeof(glm::vec3), 0, m_numVertices)
  ,
...
void Line::doUpdate(double /*time*/, const Viewport&, const Camera& camera, const CoordinateFrame&)
{
