#include "rendering/old/utility/containers/ShaderProgramContainer.h"
...
#include "rendering/old/shaders/Flat.vert"
    ;

  const char* fsStdSource =
#include "rendering/old/shaders/Flat.frag"
    ;

  const char* fsPeelSource =
#include "rendering/old/shaders/FlatPeel.frag"
    ;
...
{
  const char* vsStdSource =
#include "rendering/old/shaders/Simple.vert"
    ;

  const char* fsStdSource =
#include "rendering/old/shaders/Simple.frag"
    ;
...
{
  const char* vsStdSource =
#include "rendering/old/shaders/BasicMesh.vert"
    ;

  const char* fsStdSource =
#include "rendering/old/shaders/BasicMesh.frag"
    ;

  const char* fsPeelSource =
#include "rendering/old/shaders/BasicMeshPeel.frag"
    ;
...
{
  const char* vsStdSource =
#include "rendering/old/shaders/Mesh.vert"
    ;
...
{
  const char* fsStdSource =
#include "rendering/old/shaders/Mesh.frag"
    ;

  const char* fsPeelSource =
#include "rendering/old/shaders/MeshPeel.frag"
    ;
...
#include "rendering/old/shaders/ddp/init.vert"
    ;

  const char* fsInitSource =
#include "rendering/old/shaders/ddp/InitializeDepths.frag"
    ;

  const char* vsBlendSource =
#include "rendering/old/shaders/ddp/blend.vert"
    ;

  const char* fsBlendSource =
#include "rendering/old/shaders/ddp/blend.frag"
    ;

  const char* fsFinalSource =
#include "rendering/old/shaders/ddp/final.frag"
    ;

  const char* vsDebugSource =
#include "rendering/old/shaders/Debug.vert"
    ;

  const char* fsDebugSource =
#include "rendering/old/shaders/Debug.frag"
    ;
...
{
  const char* vsSource =
#include "rendering/old/shaders/Polygonizer.vert"
    ;

  const char* gsSource =
#include "rendering/old/shaders/Polygonizer.geom"
    ;
