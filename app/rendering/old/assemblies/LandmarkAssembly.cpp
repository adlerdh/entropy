#include "rendering/old/assemblies/LandmarkAssembly.h"

#include "rendering/old/ShaderNames.h"
#include "rendering/old/drawables/Transformation.h"
#include "rendering/old/drawables/annotation/LandmarkGroup3d.h"
...
void LandmarkAssembly::addLandmarkGroup(std::weak_ptr<LandmarkGroupRecord> lmGroupRecord)
{
  ...
  // Function that provides the transformation from modeling space of the landmark group to World
  // space
...
void LandmarkAssembly::detachLandmarks(const uuids::uuid& lmGroupUid)
{
  if (!m_rootFor2dViews || !m_rootFor3dViews) {
    throwDebug("Null root drawables in assembly");
  }
