...
#include "rendering/old/interfaces/IDrawableAssembly.h"

#include "common/ObjectCounter.hpp"
#include "common/PublicTypes.h"

#include "logic/old/records/LandmarkGroupRecord.h"

#include "rendering/common/ShaderProviderType.h"
#include "rendering/old/assemblies/RenderingProperties.h"
#include "rendering/old/common/DrawableScaling.h"
...
private:
  /// Detach drawables for a given LM group from the assembly roots
  void detachLandmarks(const uuids::uuid& lmGroupUid);
