#include "rendering/old/assemblies/AnnotationAssembly.h"

#include "rendering/old/ShaderNames.h"
#include "rendering/old/common/MeshPolygonOffset.h"
#include "rendering/old/drawables/DynamicTransformation.h"
#include "rendering/old/drawables/Transformation.h"
#include "rendering/old/drawables/annotation/AnnotationExtrusion.h"
#include "rendering/old/drawables/annotation/AnnotationSlice.h"
#include "rendering/old/records/MeshGpuRecord.h"
...
void AnnotationAssembly::setAnnotation(std::weak_ptr<SlideAnnotationRecord> annotRecord)
{
  ...
  // Function that provides the transformation from annotation to World space
...
void AnnotationAssembly::clearAnnotations()
{
    ...
    {
        detachAnnotations( lmGroup.second );
    }
...
/*
void AnnotationAssembly::detachAnnotations( const Landmarks& annot )
{
