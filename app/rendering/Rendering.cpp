...
Rendering::Rendering(AppData& appData)
  ...
  , m_meshAmbientOcclusionFilterProgram("MeshAmbientOcclusionFilterProgram")
  ...
  , m_meshImagePlaneCompositeProgram("MeshImagePlaneCompositeProgram")
  , m_meshImagePlaneCompositeTexture2DProgram("MeshImagePlaneCompositeTexture2DProgram")
  , m_meshImagePlaneBorderProgram("MeshImagePlaneBorderProgram")
  , m_meshImagePlaneCompositeDdpInitProgram("MeshImagePlaneCompositeDdpInitProgram")
  , m_meshImagePlaneCompositeDdpPeelProgram("MeshImagePlaneCompositeDdpPeelProgram")
  , m_meshDdpInitProgram("MeshDdpInitProgram")
  , m_meshDdpInitEdgesProgram("MeshDdpInitEdgesProgram")
  , m_meshDdpPeelProgram("MeshDdpPeelProgram")
  , m_meshDdpPeelEdgesProgram("MeshDdpPeelEdgesProgram")
  , m_meshDdpCompletionProgram("MeshDdpCompletionProgram")
