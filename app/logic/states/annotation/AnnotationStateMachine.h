...
public:
  ...
  static std::optional<uuid> hoveredViewUid()
  {
    return ms_hoveredViewUid;
  }

  /// @brief Get the selected view UID, in which the user is currently annotating
  static std::optional<uuid> selectedViewUid()
  {
    return ms_selectedViewUid;
  }

  /// @brief Get the active annotation that is being created and growing
  static std::optional<uuid> growingAnnotUid()
  {
