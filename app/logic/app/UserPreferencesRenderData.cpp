...
user_preferences::RenderPreferences renderPreferencesFromRenderData(const RenderData& renderData)
{
  ...
  preferences.imagePlaneAmbient = renderData.m_imagePlaneAmbient;
  preferences.imagePlaneDiffuse = renderData.m_imagePlaneDiffuse;
  preferences.imagePlaneSpecular = renderData.m_imagePlaneSpecular;
  preferences.imagePlaneShininess = renderData.m_imagePlaneShininess;
...
void applyRenderPreferences(RenderData& renderData, const user_preferences::RenderPreferences& preferences)
{
  ...
  renderData.m_imagePlaneAmbient = preferences.imagePlaneAmbient;
  renderData.m_imagePlaneDiffuse = preferences.imagePlaneDiffuse;
  renderData.m_imagePlaneSpecular = preferences.imagePlaneSpecular;
  renderData.m_imagePlaneShininess = preferences.imagePlaneShininess;
