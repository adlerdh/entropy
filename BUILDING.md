...
| `Entropy_WINDOWS_PACKAGE_STATIC_SMALL_DEPS` | Boolean | `ON` in release presets, `OFF` otherwise | Windows dependency/package stage | Builds GLFW, Native File Dialog Extended, and spdlog as static libraries for Windows release packages. ITK and Qt keep the normal Windows dynamic linkage. |
