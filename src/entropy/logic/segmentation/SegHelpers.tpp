...
template<typename T>
std::optional<glm::vec3> computePixelCentroid(const void* data, const glm::ivec3& dims, const LabelType& label)
{
...
template<typename T>
LabelIndexMaps createLabelIndexMaps(const glm::ivec3& dims, const T* buffer, bool ignoreBackgroundZeroLabel)
{
