...
public:
  ...
  static std::optional<uuid> hoveredViewUid() { return ms_hoveredViewUid; }

  /// @brief Get the selected view UID, in which the user is currently annotating
  static std::optional<uuid> selectedViewUid() { return ms_selectedViewUid; }

  /// @brief Get the active annotation that is being created and growing
  static std::optional<uuid> growingAnnotUid() { return ms_growingAnnotUid; }
...
protected:
  ...
  static std::optional<uuid> ms_hoveredViewUid;

  /// Selected view UID, in which the user is currently annotating
  static std::optional<uuid> ms_selectedViewUid;

  /// The annotation that is currently being created and that can grow
  static std::optional<uuid> ms_growingAnnotUid;
  ...
  static std::optional<uuid> ms_hoveredAnnotUid;
...
using ASM = state::annot::AnnotationStateMachine;
