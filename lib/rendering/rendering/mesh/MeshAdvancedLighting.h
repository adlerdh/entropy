...
struct MeshAmbientOcclusionSettings
{
  ...
  float strength = 1.0f;     //!< Occlusion contribution in [0, 1]
  float power = 1.5f;        //!< Nonlinear AO response exponent
...
struct MeshAmbientOcclusionPlan
{
  ...
  float strength = 1.0f;     //!< Sanitized AO strength
  float power = 1.5f;        //!< Sanitized AO response exponent
