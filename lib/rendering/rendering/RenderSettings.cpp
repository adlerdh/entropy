...
RenderSettings::RenderSettings()
  ...
  , m_showTransformationGuides(true)
  , m_transformationGuideColor(1.0f, 0.772549f, 0.313725f, 1.0f)
  ...
  , m_scaleBarColor(0.509804f, 0.819608f, 0.427451f, 1.0f)
  ...
  , m_meshCutawayEnabled(false)
  , m_showCrosshairsIn3D(true)
  , m_crosshairs3DGlyphDiameterScenePercent(0.25f)
  , m_crosshairs3DGlyphLengthScenePercent(4.0f)
  , m_landmarkSphereRadiusScenePercent(0.5f)
