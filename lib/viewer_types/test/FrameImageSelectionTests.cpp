...
TEST_CASE("frame image selection filters default rendered images", "[viewer_types][frame_image_selection]")
{
  const std::list imageUids{uuidFromIndex(1), uuidFromIndex(2), uuidFromIndex(3)};
  viewer_types::FrameImageSelection selection;
...
TEST_CASE("frame image selection inserts rendered images in application order", "[viewer_types][frame_image_selection]")
{
...
TEST_CASE(
  "frame image selection ignores rendered images outside application order",
  "[viewer_types][frame_image_selection]")
{
...
TEST_CASE("frame image selection keeps at most two metric images", "[viewer_types][frame_image_selection]")
{
...
TEST_CASE(
  "frame image selection ignores metric images outside application order",
  "[viewer_types][frame_image_selection]")
{
  const std::vector ordered{uuidFromIndex(1), uuidFromIndex(2)};
  viewer_types::FrameImageSelection selection;
...
TEST_CASE("frame image selection exposes visible images by render mode", "[viewer_types][frame_image_selection]")
{
  viewer_types::FrameImageSelection selection;
...
TEST_CASE("frame image selection reorders selections and drops missing images", "[viewer_types][frame_image_selection]")
{
  viewer_types::FrameImageSelection selection;
