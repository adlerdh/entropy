...
TEST_CASE("layout kind enum ordinals remain stable for serialized layout specs", "[viewer_types][layout]")
{
...
TEST_CASE("camera sync mode enum ordinals remain stable for layout sync specs", "[viewer_types][layout]")
{
