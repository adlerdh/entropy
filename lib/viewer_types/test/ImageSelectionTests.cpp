...
namespace image_selection = viewer_types::image_selection;
...
TEST_CASE("default image filtering keeps all images when render-all is enabled", "[viewer_types][image_selection]")
{
...
TEST_CASE("default image filtering keeps preferred zero-based image positions", "[viewer_types][image_selection]")
{
...
TEST_CASE(
  "selected images reorder to match current image order and drop missing UIDs",
  "[viewer_types][image_selection]")
{
...
TEST_CASE("selected image reordering can limit metric selections", "[viewer_types][image_selection]")
{
