...
TEST_CASE("2D render mode choices stay in stable UI order", "[viewer_types][modes]")
{
...
TEST_CASE("3D render mode choices stay in stable UI order", "[viewer_types][modes]")
{
...
TEST_CASE("view render mode enum ordinals remain stable for serialized layout specs", "[viewer_types][modes]")
{
...
TEST_CASE("intensity projection modes stay in stable UI order", "[viewer_types][modes]")
{
...
TEST_CASE("intensity projection enum ordinals remain stable for serialized layout specs", "[viewer_types][modes]")
{
...
TEST_CASE("viewer mode labels cover all public choices", "[viewer_types][modes]")
{
...
TEST_CASE("viewer mode labels tolerate sentinel values", "[viewer_types][modes]")
{
