...
TEST_CASE("frame viewport defaults to the full window clip viewport", "[viewer][frame_viewport]")
{
  const viewer::FrameViewport viewport;
...
TEST_CASE("frame viewport computes window clip transform from viewport bounds", "[viewer][frame_viewport]")
{
  const viewer::FrameViewport viewport{glm::vec4{-1.0f, 0.0f, 1.0f, 1.0f}};
...
TEST_CASE("frame viewport updates inverse transform when bounds change", "[viewer][frame_viewport]")
{
  viewer::FrameViewport viewport{glm::vec4{-1.0f, -1.0f, 1.0f, 1.0f}};
