...
TEST_CASE("camera sync groups create independent groups by mode", "[viewer][camera_sync_groups]")
{
...
TEST_CASE("camera sync groups track view membership", "[viewer][camera_sync_groups]")
{
  viewer::CameraSyncGroups groups;
  ...
  CHECK(*group == viewer::CameraSyncGroups::Group{firstView, secondView});
...
TEST_CASE("camera sync groups ignore missing optional group UIDs", "[viewer][camera_sync_groups]")
{
  viewer::CameraSyncGroups groups;
