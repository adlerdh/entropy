...
void to_json(nlohmann::json& j, const BackendConfig& value)
{
  j = nlohmann::json{
    ...
    {"antsConvertTransformFileExecutable", pathToString(value.antsConvertTransformFileExecutable)},
...
void from_json(const nlohmann::json& j, BackendConfig& value)
{
  ...
  if (j.contains("antsConvertTransformFileExecutable")) {
    value.antsConvertTransformFileExecutable = pathFromJson(j.at("antsConvertTransformFileExecutable"));
  }
