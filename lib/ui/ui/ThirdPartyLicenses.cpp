...
static const LicenseDocument sk_gifticlibDocs[] = {{"Copyright and license text:", "licenses/gifticlib.txt"}};
...
static const LicenseEntry sk_entries[] = {
  ...
  {"gifticlib",
   ...
   "Public domain",
   "Built privately through ITK to read and write GIFTI surface files.",
   sk_gifticlibDocs,
   count(sk_gifticlibDocs)},
  {"GLAD OpenGL loaders",
  ...
  {"Insight Toolkit (ITK)",
   ...
   "ITKDistanceMap, ITKDisplacementField, ITKImageGrid, ITKImageFunction, ITKIOMeshFreeSurfer, ITKIOMeshGifti, "
   "ITKIOMeshOFF, and ITKStatistics. Compiled ITK libraries, including transitive dependencies: ITKCommon, "
   "ITKConvolution, ITKEXPAT, ITKFFT, ITKIOBMP, ITKIOGDCM, ITKIOImageBase, ITKIOJPEG, ITKIOMeshBase, "
   "ITKIOMeshFreeSurfer, ITKIOMeshGifti, ITKIOMeshOFF, ITKIOMeta, ITKIONIFTI, ITKIONRRD, ITKIOPNG, ITKIOTIFF, "
   "ITKImageIntensity, ITKLabelMap, ITKMathematicalMorphology, ITKMesh, ITKMetaIO, ITKNrrdIO, ITKPath, "
   "ITKQuadEdgeMesh, ITKSmoothing, ITKSpatialObjects, ITKStatistics, ITKTransform, ITKVNLInstantiation, and "
   "ITKVoronoi. ITKVTK and all other optional ITK modules are disabled. "
  ...
  {"Visualization Toolkit (VTK)",
   ...
   "including transitive dependencies: VTK::CommonColor, VTK::CommonComputationalGeometry, VTK::CommonCore, "
   ...
   "VTK::FiltersHybrid, VTK::FiltersModeling, VTK::FiltersReduction, VTK::FiltersSources, VTK::FiltersVerdict, "
   "VTK::IOCellGrid, VTK::IOCore, VTK::IOGeometry, VTK::IOImage, VTK::IOLegacy, VTK::IOPLY, VTK::IOXML, "
   "VTK::IOXMLParser, VTK::ImagingCore, VTK::ImagingGeneral, VTK::ImagingSources, VTK::ImagingStatistics, and "
   "VTK::RenderingCore. Views, Web, MPI, and Qt integration modules are disabled.",
   sk_vtkDocs,
   count(sk_vtkDocs)},
};
