...
if(Entropy_USE_CCACHE)
  ...
  # Remove only a launcher installed by the ccache option. Keep explicit launchers such as sccache.
  foreach(_launcher_var IN ITEMS CMAKE_C_COMPILER_LAUNCHER CMAKE_CXX_COMPILER_LAUNCHER CMAKE_OBJCXX_COMPILER_LAUNCHER)
    if(CCACHE_PROGRAM AND "${${_launcher_var}}" STREQUAL "${CCACHE_PROGRAM}")
      unset(${_launcher_var} CACHE)
    endif()
  endforeach()
endif()
...
function(entropy_add_cppcheck_target)
  ...
  add_custom_target(cppcheck
    ...
    COMMAND
      ...
      "--suppress=*:${CMAKE_SOURCE_DIR}/lib/image/image/external/*"
      "--suppress=*:${CMAKE_BINARY_DIR}/*"
      "--project=${CMAKE_BINARY_DIR}/compile_commands.json"
      "-i${CMAKE_SOURCE_DIR}/external"
      "-i${CMAKE_SOURCE_DIR}/lib/image/image/external"
      "-i${CMAKE_BINARY_DIR}"
      "-i${CMAKE_SOURCE_DIR}/app/logic/app/AppPathsMac.mm"
      "-i${CMAKE_SOURCE_DIR}/lib/ui/ui/ClipboardMac.mm"
      "-i${CMAKE_SOURCE_DIR}/lib/ui/ui/dialogs/NativeMessageDialogsMac.mm"
      "-i${CMAKE_SOURCE_DIR}/lib/ui/ui/menus/MacNativeMainMenu.mm"
